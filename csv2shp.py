...
def main():
    ...
    print ("Hola, bienvenido a CreatorSurikat")

    filename = raw_input("introduzca el nombre del archivo (sin extension)") + '.csv'
    input_file =  filename
    output_file = 'filename.shp'
...
def usage():
    ...
    print('    report_latitude or lat (case insensitive)')
    print('    report_longitude, lon, or long (case insensitive)\n')
...
class KMLFromCSVPoints(object):
    ...
    def add_initial_lookat(self, doc):
        ...
        # create lat/lon tags
        self.add_element(lookat, 'report_latitude', str(self.initial_position[0]))
        self.add_element(lookat, 'report_longitude', str(self.initial_position[1]))
...
class CSVPoints(object):
    ...
    def get_lat_lon_col_nums(self):
        ...
        lats = ['report_latitude', 'lat','LAT_POB']
        ...
        lons = ['report_longitude', 'lon', 'long', 'LNG_POB']
